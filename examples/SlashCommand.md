...
```js
const { MessageAttachment } = require('discord.js-selfbot')
const fs = require('fs')
...
> [dijnie/discord.js-selfbot#1055 (comment)](https://github.com/dijnie/discord.js-selfbot/issues/1055#issuecomment-1949653100)
